...
class VideoLocalDataSource @Inject constructor(
    ...
    fun getVideoList() = flow {
        ...
        val firstRowAdapter = ArrayObjectAdapter(VideoListPresenter())
        firstRowAdapter.add(
            VideoEntity(
                id = 1,
        ...
        val secondRowAdapter = ArrayObjectAdapter(VideoListPresenter())
        secondRowAdapter.add(
            VideoEntity(
                id = 11,
        ...
        val thirdRowAdapter = ArrayObjectAdapter(VideoListPresenter())
        thirdRowAdapter.add(
            VideoEntity(
                id = 21,
                titleFa = "شهر خدا",
        ...
        emit(
            ArrayObjectAdapter(ListRowPresenter()).apply {
                add(ListRow(firstRowAdapter))
                add(ListRow(secondRowAdapter))
                add(ListRow(thirdRowAdapter))
            }
        )
    }
}
